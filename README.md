...
- A C++ compiler that supports C++20 and `std::format` (tested with GCC 15.3.0; theortically should work with GCC/g++ >=13 but doesn't seem to compile on GCC/g++ 13; not tested with Clang)
