...
debug:
	...
	cmake -S . -B $(debug_output) -DCMAKE_TOOLCHAIN_FILE="$(debug_output)/conan_toolchain.cmake"
...
release:
	...
	cmake -S . -B $(release_output) -DCMAKE_TOOLCHAIN_FILE="$(release_output)/conan_toolchain.cmake"
