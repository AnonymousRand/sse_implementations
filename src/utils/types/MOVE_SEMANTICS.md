...
- examples can be found in [src/utils/types/i_disk_storage.h](src/utils/types/i_disk_storage.h) and [src/utils/types/db/](src/utils/types/db/) ("copy/move" methods).
